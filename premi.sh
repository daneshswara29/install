...
data_ip="https://raw.githubusercontent.com/daneshswara29/install/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/D_swara"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
checking_sc
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME D_swara AUTOSCRIPT PREMIUM${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/daneshswara29/install/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/daneshswara29/install/main/ip"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> D_swara VPN STORE SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/D_swara"}]]}' 
...
wget -q https://raw.githubusercontent.com/daneshswara29/install/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
